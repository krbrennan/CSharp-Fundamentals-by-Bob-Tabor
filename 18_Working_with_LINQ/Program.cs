...
namespace UnderstandingLINQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Car> additionalCars = new List<Car>() {
               new Car() { VIN="A1", Make = "BMW", Model= "550i", StickerPrice=55000, Year=2009},
                new Car() { VIN="B2", Make="Toyota", Model="4Runner", StickerPrice=35000, Year=2010},
                new Car() { VIN="C3", Make="BMW", Model = "745li", StickerPrice=75000, Year=2008},
                new Car() { VIN="D4", Make="Ford", Model="Escape", StickerPrice=25000, Year=2008},
            ...
            */
            ...
            //var allCars = myCars.Union(additionalCars);
            var uniqueCars = myCars.Except(additionalCars);

            foreach (var car in uniqueCars)
            {
                Console.WriteLine($"{car.VIN} {car.Make} {car.Model} {car.Year}");
            }
